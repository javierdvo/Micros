...
_0x0:
	...
	.DB  0x75,0x72,0x61,0x3A,0x0,0x25,0x33,0x2E
	.DB  0x31,0x66,0x20,0x25,0x63,0x43,0x20,0x20
	.DB  0x0
_0x2000000:
...
_main:
; 0000 001B      ConfiguraLCD();
	RCALL _ConfiguraLCD
; 0000 001C     DIDR0=0x20;    //deshabilita el digital
	LDI  R30,LOW(32)
	STS  126,R30
; 0000 001D     ADMUX=ADC_VREF_TYPE & 0xff; // configracion prescale
	LDI  R30,LOW(192)
	STS  124,R30
; 0000 001E     MoverCursor(2,0);
	LDI  R30,LOW(2)
	ST   -Y,R30
	LDI  R30,LOW(0)
	ST   -Y,R30
	RCALL _MoverCursor
; 0000 001F     StringLCD("Temperatura:");
	__POINTW1FN _0x0,0
	ST   -Y,R31
	ST   -Y,R30
	RCALL _StringLCD
; 0000 0020     ADCSRA=0x83; //habiliuta adc
	LDI  R30,LOW(131)
	STS  122,R30
; 0000 0021 
; 0000 0022     while(1){
_0x43:
; 0000 0023         tempDigital=read_adc(5);
	LDI  R30,LOW(5)
	ST   -Y,R30
	RCALL _read_adc
	STS  _tempDigital,R30
	STS  _tempDigital+1,R31
; 0000 0024         temperatura= tempDigital*110.0/1024.0;
	CLR  R22
	CLR  R23
	CALL __CDF1
	__GETD2N 0x42DC0000
...
; 0000 0025         sprintf(cadena,"%3.1f %cC  ",temperatura,0xDF);
	LDI  R30,LOW(_cadena)
