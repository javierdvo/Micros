    ...
    //Librería del display de cuarzo líquido. Agustín Domínguez O. Ver 2.0
...
void ConfiguraLCD()
{
    ...
    DDRC=DDRC|0x0F;      //Cambiar a salida aquellos pines de ser necesario
     DDRD=DDRD|0x84;      //Cambiar a salida aquellos pines de ser necesario  
...
/* Procedimiento que manda un string fijo al LCD en donde se encuentre el cursor, letra por letra con el retardo en mseg*/
void StringLCD2(flash unsigned char Mensaje[],unsigned int tiempo)
{
 unsigned char i;
 i=0;
 do{
